...
const ELEMENT_DEFAULTS: Record<ElementType, { w: number; h: number; name: string; props: Record<string, any> }> = {
  ...
  avatar: { w: 500, h: 900, name: 'Avatar 3D', props: { position: 'center', scale: 1.5, animation: 'idle', enabled: true, avatarUrl: '/models/avatar.glb', animationsUrl: '/models/animations.glb', colors: { shirt: '#1E3A8A', pants: '#1F2937', shoes: '#000000' } } },
};
