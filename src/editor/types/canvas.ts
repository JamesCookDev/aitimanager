...
const ELEMENT_DEFAULTS: Record<ElementType, { w: number; h: number; name: string; props: Record<string, any> }> = {
  ...
  store: { w: 480, h: 600, name: 'Diretório de Lojas', props: { title: 'Lojas', titleColor: '#ffffff', titleSize: 28, bgColor: 'rgba(0,0,0,0.6)', borderRadius: 16, stores: [{ id: '1', name: 'Loja Exemplo', logo: '', floor: 'Piso 1', category: 'Moda', hours: '10h–22h', phone: '', description: 'Moda masculina e feminina' }], columns: 1, gap: 12, cardBgColor: 'rgba(255,255,255,0.08)', cardBorderRadius: 12, accentColor: '#6366f1', showCategory: true, showHours: true, showPhone: true, showFloor: true } },
};
